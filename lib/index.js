let main = (() => {
  var _ref = _asyncToGenerator(function* () {
    try {
      ...
      yield sshServer.connect(SELECTED_CONFIG.ssh);
      yield upload(sshServer.ssh, SELECTED_CONFIG, localFile, targetFile);
      yield run(sshServer.ssh, 'tar -xzf ' + targetFile, SELECTED_CONFIG.deployDir);
      yield run(sshServer.ssh, 'mv ' + SELECTED_CONFIG.targetName + ' ' + SELECTED_CONFIG.releaseDir, SELECTED_CONFIG.deployDir);
      yield run(sshServer.ssh, 'rm -f ' + targetFile, SELECTED_CONFIG.deployDir);
